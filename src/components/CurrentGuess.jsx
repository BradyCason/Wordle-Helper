...
export default function CurrentGuess({onSubmit, word, color1, color2, color3, color4, color5, changeColor1, changeColor2, changeColor3, changeColor4, changeColor5}) {
  ...
  if (word){
    return (
      <div className="vert-flex">
        ...
        <button className={"button button-grey"} onClick={onSubmit}>Submit</button>
      </div>
    )
  }
  else{
